...
<Modal {open} {onClose} title="批量绑定/解绑" maxWidth="520px" maxHeight="720px">
  <div class="bulk-modal">
    ...
    <div class="search-bar">
      <SearchInput placeholder="搜索联系人/群组..." bind:value={searchTerm} />
      <div class="actions">
    ...
    <div class="list">
      ...
      {:else}
        {#each filteredItems as item (item.id)}
          ...
          <button class="list-item" class:selected={checked} onclick={() => toggleItem(item.id)}>
            <input
              type="checkbox"
              {checked}
