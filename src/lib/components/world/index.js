...
export {
    // Constants
    DEFAULT_DEPTH,
    DEFAULT_WEIGHT, POSITION_OPTIONS,
    ROLE_OPTIONS, SELECTIVE_LOGIC_OPTIONS, buildOptions, createDefaultEntry,
    // Functions
    deepClone, downloadJson, normalizeArray,
    normalizeEntry, positionLabel, toNumber
} from './world-types.js';
