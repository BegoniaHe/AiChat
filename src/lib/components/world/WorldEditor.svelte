<script>
  ...
  import { createDefaultEntry, deepClone, normalizeEntry, positionLabel } from './world-types.js';
  ...
  <div class="world-editor-body">
    ...
    <div class="entries-column">
      <div class="entries-toolbar">
        <button class="btn btn-primary" onclick={addEntry}> ＋ 新条目 </button>
      </div>
      <ul class="entries-list">
        {#each data.entries as entry, i (entry.id)}
          <li class="entry-item" class:active={i === currentIndex} onclick={() => selectEntry(i)}>
            <div class="entry-lights">
              <span class="light" class:red={entry.disable} class:green={!entry.disable}></span>
              <span class="light" class:blue={entry.constant}></span>
            </div>
    ...
    <div class="editor-column">
      {#if currentEntry}
        <WorldEntryEditor bind:entry={data.entries[currentIndex]} {onEntryChange} />
        <div class="editor-actions">
          <button class="btn btn-secondary" onclick={duplicateEntry}> 复制条目 </button>
