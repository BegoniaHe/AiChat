...
<div class="editor-section">
  <div class="section-header">
    ...
    <div class="section-desc">与 ST 相同：控制序列/包裹/宏（目前仅保存，暂未用于 prompt 构建）</div>
  </div>
  ...
  <div class="input-row">
    ...
    <div class="input-cell">
      ...
      <input type="text" class="field-input" bind:value={outputSequence} />
    </div>
  </div>
  ...
  <div class="input-row">
    <div class="input-cell">
      ...
      <input type="text" class="field-input" bind:value={systemSequence} />
    </div>
    <div class="input-cell">
