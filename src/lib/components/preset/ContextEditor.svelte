<script>
  ...
  let position = $state(preset.story_string_position ?? EXT_PROMPT_TYPES.IN_PROMPT);
...
<div class="editor-section">
  ...
  <div class="input-row">
    ...
    <div class="input-cell">
      ...
      <input type="number" class="field-input" bind:value={depth} min="0" />
    </div>
    <div class="input-cell">
  ...
  <div class="input-row">
    <div class="input-cell">
      ...
      <input type="text" class="field-input" bind:value={exampleSeparator} />
    </div>
    <div class="input-cell">
