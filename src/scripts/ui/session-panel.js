...
export class SessionPanel {
    ...
    refresh() {
        ...
        contacts.forEach((c) => {
            ...
            name.innerHTML = `<strong>${displayName}${unreadBadge}${badge}${currentTag}</strong><br><span style="color:#888;font-size:12px;">${snippet}</span> ${time ? `<span style="color:#9ca3af;font-size:11px;">${time}</span>` : ''}`;
            if (id === currentId) {
